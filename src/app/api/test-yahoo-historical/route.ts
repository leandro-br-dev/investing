...
export async function GET(req: NextRequest) {
  try {
    ...
    console.log(`📈 Testando dados históricos do Yahoo Finance para ${ticker} (${days} dias)`)
    ...
    try {
      ...
      console.log(`✅ Encontrados ${historical.length} registros históricos para ${ticker}`)
      ...
      console.error('❌ Erro nos dados históricos do Yahoo Finance:', yahooError)
      ...
      return NextResponse.json({
        ...
        ticker,
        suggestion: "Verifique se o ticker está correto e se há dados históricos disponíveis",
